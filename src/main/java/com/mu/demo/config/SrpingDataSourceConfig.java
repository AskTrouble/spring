 ...
 */
@Configuration
@MapperScan(basePackages = SrpingDataSourceConfig.PACKAGE, sqlSessionFactoryRef = "springSqlSessionFactory")
public class SrpingDataSourceConfig {

    static final String PACKAGE = "com.mu.demo.dao.spring";
    static final String MAPPER_LOCATION = "classpath:mapper/spring/*.xml";
    ...
    public SqlSessionFactory springSqlSessionFactory(@Qualifier("springDataSource") DataSource springDataSource)
            throws Exception {
        final SqlSessionFactoryBean sessionFactory = new SqlSessionFactoryBean();
        sessionFactory.setDataSource(springDataSource);
        sessionFactory.setMapperLocations(new PathMatchingResourcePatternResolver()
                .getResources(SrpingDataSourceConfig.MAPPER_LOCATION));
        ...
        //是否分页合理化
        //reasonable参数，表示分页合理化，默认值为false。
